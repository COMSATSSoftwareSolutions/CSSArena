...
<head>
  ...
  <!-- <link rel="stylesheet" href="resources\css\tempusdominus-bootstrap-4.min.css"> -->
  <!-- iCheck -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('Index')}}" class="brand-link">
      <img src="{{ asset('img/logo/logo.png') }}" alt="Css-Arena" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('images/user/no-img.png') }}" class="img-circle elevation-2" alt="">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('prod_cat_create') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
...
<!-- ==============+============+===============+================+=====================+====================++================= -->
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2019 <a href="http://css-arena.com">CSS-Arena</a>.</strong>
    All rights reserved.
...
<!-- <script src="admin\home\js\plugins\Chart.min.js"></script> -->
<script src="https://cdn.jsdelivr.net/npm/chart.js@2.8.0"></script>
<!-- Sparkline -->
<!-- <script src="js/plugins/sparkline.js"></script> -->
...
<!-- <script src="js/plugins/jquery.vmap.usa.js"></script> -->
...
<script src="{{ asset('js/plugins/daterangepicker.js') }}" defer></script>

<!-- Tempusdominus Bootstrap 4 -->
<script src="{{ asset('js/plugins/tempusdominus-bootstrap-4.min.js') }}" defer></script>

<!-- Summernote -->
<script src="{{ asset('js/plugins/summernote-bs4.min.js') }}" defer></script>

<!-- overlayScrollbars -->
<script src="{{ asset('js/plugins/jquery.overlayScrollbars.min.js') }}" defer></script>

<!-- AdminLTE App -->
<script src="{{ asset('js/dist/adminlte.js') }}" defer></script>
